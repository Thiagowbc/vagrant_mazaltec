...
echo "---- Iniciando instalacao do ambiente de Desenvolvimento PHP [MazalTec] ---"
...
sudo apt-get install php7.3-cli libapache2-mod-php7.3 php7.3-curl php7.3-memcached php7.3-dev php7.3-mcrypt php7.3-sqlite3 php7.3-mbstring php7.3-mysql  php7.3-gd php7.3-xml php7.3-bcmath php7.3-mbstring php7.3-json zip unzip --assume-yes --force-yes
...
echo "[OK] --- Ambiente de desenvolvimento concluido Mazal Tov !!!---"
